...
@section('content')
    <div class="container">
        ...
        <section class="container">
                    ...
                    <tbody class="table-group-divider">
                        @foreach ($employees as $employee)
                            <tr>
                                ...
                                <td>R$ {{$employee->profession->salary}}</td>
            ...
            @else
                <p>There are no employees in our system. ... <a href="{{route('employees.create')}}" class="btn btn-link" id="create_employees" title="Register employees">Register employees</a></p>
            @endif
        </section>
    </div>
@endsection
